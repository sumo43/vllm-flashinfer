...
class ReqToTokenPool:
    ...
    def can_allocate(self, need_size):
        return self.can_use_mem_size > need_size
...
class TokenToKVPool:
    ...
    def can_append_slot(self, seq_group: SequenceGroup) -> bool:
        ...
        num_free_gpu_blocks = self.size - self.alloc_ct
